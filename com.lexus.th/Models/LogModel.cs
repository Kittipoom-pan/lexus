...
namespace com.lexus.th
{
    public class LogModel
    {
        public LogModel()
        {
            ...
            string format = WebConfigurationManager.AppSettings["error_log_path"];
        ...
        public void WriteCustomLog(string customString, string description)
        {
            ...
            using (StreamWriter writer = new StreamWriter(path, true))
            {
                ...
                writer.WriteLine(string.Format("{0} --> {1} {2} {3} --> {4}", timestamp, split[split.Count() - 1], customString_, description, "!!!!!!"));
            }
        }
