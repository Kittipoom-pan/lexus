...
namespace com.lexus.th.web
{
    ...
    {
        /// <summary>
        /// Art der w๖chentlichen Wiederholung, erste, zweit, dritte, vierte oder letzte Woche
        /// </summary>
        ...
        /// <summary>
        /// Tไgliche Ausfhrung: Legt den Interval der Ausfhrung fest
        /// </summary>
        ...
        /// <summary>
        /// W๖chentliche Ausfhrung: Tage an denen der Task ausgefhrt werden soll
        /// </summary>
        public class TriggerSettingsWeekly
        {
            private bool[] _DaysOfWeek;
            /// <summary>
            /// W๖chentliche Ausfhrung: Aktiviert oder deaktiviert einen Wochentag
            /// </summary>
        ...
        /// <summary>
        /// Einstellungen wann ein Trigger ausgel๖st werden soll
        /// </summary>
        ...
        public class TriggerItem
        {
            ...
            private TimeSpan _HitTimeSpan = new TimeSpan(0, 0, 1); // Zeitfenster in dem ein Trigger ausgel๖st wird (_TriggerTime + HitTimeWindow)
            private DateTime _NextTriggerDate; // Letzter ausgel๖ster Trigger
            private TriggerSettings _TriggerSettings; // Trigger-Flags - speichert die Einstellungen wann der Trigger ausgel๖st werden soll
            ...
            /// <summary>
            /// Zeitfenster in dem ein Trigger ausgel๖st wird.
            /// Die zu aktuelle Zeit muss im Zeitfenster TriggerTime + HitTimeSpan liegen damit der Trigger ausgel๖st wird
            /// </summary>
            ...
            /// <summary>
            /// Ermittelt oder legt fest wann der Trigger ausgel๖st werden soll
            /// </summary>
            [XmlElement(Order = 4)]
            ...
            {
                return (WeekDayOccurInMonth(date.AddDays(7)) == 0); // Der Wochentag kommt als letztes vor wenn der gleiche Wochentag eine Woche spไter das Erste mal (im Monat) vorkommt
            }
            ...
            /// <summary>
            /// Trigger-Prfung fr tไgliche Ausfhrung
            /// </summary>
            ...
            /// <summary>
            /// Trigger-Prfung fr w๖chentliche Ausfhrung
            /// </summary>
            /// <returns></returns>
            ...
            /// <summary>
            /// Prft ob an einem bestimmten Datum der Trigger ausgel๖st wrde
            /// </summary>
            /// <returns></returns>
            ...
            public bool RunCheck(DateTime dateTimeToCheck)
            {
                ...
                if (_Enabled) // Trigger aktiv?
                {
                    ...
                    if ((dateTimeToCheck >= triggerDateTime) && (dateTimeToCheck <= triggerDateTime.AddTicks(_HitTimeSpan.Ticks))) // Trigger-Zeit berschritten? => Trigger ausl๖sen
                    {
                        OnTriggerEventArgs eventArgs = new OnTriggerEventArgs(this, triggerDateTime);
                        _NextTriggerDate = FindNextTriggerDate(_NextTriggerDate.AddDays(1)); // Einen Tag spไter fortfahren
                        if (OnTrigger != null)
            ...
            /// <summary>
            /// Sucht den Zeitpunkt der nไchsten Ausfhrung
            /// </summary>
            private DateTime FindNextTriggerDate(DateTime searchStartDateTime)
            {
                DateTime date = searchStartDateTime.Date;

                // Wenn die aktuelle Uhrzeit die TriggerTime berschritten hat die Suche am nไchsten Tag fortsetzen
            ...
            /// <summary>
            /// Ermittelt das Datum der nไchsten Ausfhrung unabhไnging der Trigger-Zeit
            /// </summary>
            /// <returns></returns>
