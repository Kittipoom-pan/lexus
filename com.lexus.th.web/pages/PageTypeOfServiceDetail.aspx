<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageTypeOfServiceDetail.aspx.cs" Inherits="com.lexus.th.web.master.PageTypeOfServiceDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Type Of Service Detail</h3>
        </div>
    </div>

    <div class="row">
        <label class="col-md-2">Type Of Service Detail Search</label>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-3">
            <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Type Of Service Detail</span></asp:LinkButton>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvCust" runat="server" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Type Of Service Id" DataField="TYPE_OF_SERVICE_ID" />
                                <asp:BoundField HeaderText="Type Of Service Name" DataField="TYPE_OF_SERVICE_NAME" />
            ...
            <asp:UpdatePanel ID="upModalAdd" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <a class="close" data-dismiss="modal">&times;</a>
                            <h4 class="modal-title">Type Of Service Detail</h4>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" CssClass="form-control" ID="dlTypeOfService" DataValueField="ID" DataTextField="NAME_EN">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
