<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageEvent.aspx.cs" Inherits="com.lexus.th.web.master.PageEvent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <label class="col-md-2">Events Search</label>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-3">
            <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Event</span></asp:LinkButton>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvCust" runat="server" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Register Period Start" DataField="REG_PERIOD_START" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                <asp:BoundField HeaderText="Register Period End" DataField="REG_PERIOD_END" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                <asp:BoundField HeaderText="Event Start" DataField="EVENT_START" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                <asp:BoundField HeaderText="Event End" DataField="EVENT_END" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                        ...
                        <asp:GridView ID="gvQuestion" runat="server" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Question Type">
                                    <ItemTemplate>
                                        <%# (Eval("question_type").ToString().ToLower().Equals("1") ? "Car Owner" :
                                                Eval("question_type").ToString().ToLower().Equals("2")?"Representative":
                                                Eval("question_type").ToString().ToLower().Equals("3")?"Follower ของ Car Owner":
                                                Eval("question_type").ToString().ToLower().Equals("4")?"Follower ของ Representative":"") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Active">
                                    <ItemTemplate>
                                        <%# (Eval("is_active").ToString().ToLower().Equals("1") ? "<i class='fa fa-check' style='font-size:36px;color:#5cb85c'></i>" : "<i class='fa fa-close' style='font-size:36px;color:red'></i>") %>
                                    </ItemTemplate>
                                </asp:TemplateField>
            ...
            <asp:UpdatePanel ID="upModalAdd" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                             <!-- Prefered Model -->
                            <asp:Button ID="btnDetail" runat="server" class="btn btn-default" Text="Event Detail" OnClick="Menu_Click" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="tbEventStart" runat="server" ValidationGroup="Save"><span class="glyphicon glyphicon glyphicon-warning-sign" style="color:orange"></span><span style="color:orange"> Required field</span></asp:RequiredFieldValidator>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="tbEventStart" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Event End</label>
                                                <asp:RequiredFieldValidator Display="Dynamic" ControlToValidate="tbEventEnd" runat="server" ValidationGroup="Save"><span class="glyphicon glyphicon glyphicon-warning-sign" style="color:orange"></span><span style="color:orange"> Required field</span></asp:RequiredFieldValidator>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="tbEventEnd" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Limit Guest</label>
                                                <asp:TextBox runat="server" CssClass="form-control" ID="tbLimitGuest" autocomplete="off"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Follower Detail</label>
                                                <asp:DropDownList runat="server" ID="dlWithoutGuest" CssClass="form-control">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" ID="dlCarOwnerOnly" CssClass="form-control">
                                                    <asp:ListItem Text="Enable" Value="0" />
                                                    <asp:ListItem Text="Disable" Value="1" />
                                                </asp:DropDownList>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Allocation of rights</label>
                                                <asp:CheckBoxList runat="server" ID="chkgAllocationOfRights"  DataValueField="ID" DataTextField="NAME_EN" OnSelectedIndexChanged="chkgAllocationOfRights_SelectedIndexChanged"></asp:CheckBoxList>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group ">
                                                <label>1 VIN per Event</label><asp:Label id="lbNotSet" runat="server" ForeColor="red" Font-Bold="True" Text="(Not Set)"/>
                                                <asp:CheckBox runat="server" ID="cbOneVinPerEvent" CssClass="form-control" Text="Allow"/>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" ID="dlEventType" CssClass="form-control">
                                                    <asp:ListItem Text="Normal" Value="normal" />
                                                    <asp:ListItem Text="Invitation" Value="invitation" />
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Period car age</label><br />
                                                   <asp:DropDownList ID="dlCarAgeStart" width="25%" runat="server" CssClass="form-control dropdown" AutoPostBack="true" DataValueField="CarAgeStart" DataTextField="CarAgeStart"></asp:DropDownList>  to  <asp:DropDownList ID="dlCarAgeEnd" width="25%" runat="server" CssClass="form-control dropdown" AutoPostBack="true" DataValueField="CarAgeEnd" DataTextField="CarAgeEnd"/>  
<%--                                                   <asp:CompareValidator runat="server" ID="CompareValidator1" ControlToCompare="dlCarAgeStart" ControlToValidate="dlCarAgeEnd" Operator="GreaterThanEqual" ErrorMessage="Period car age start must greater than period car age end"></asp:CompareValidator>--%>
                                            </div>
                                        </div>
                                        <br />
                                        <div class="col-md-6">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="banner" role="tabpanel" aria-labelledby="banner-tab">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Image - Event Banner</label><asp:Label ID="lbImgBanner1" runat="server" ForeColor="Orange"></asp:Label>
                                            ...
                                            <div class="tab-pane" id="bannerDetail" role="tabpanel" aria-labelledby="bannerDetail-tab">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>Image - Event Banner Detail</label><asp:Label ID="lbImg1" runat="server" ForeColor="Orange"></asp:Label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" CssClass="form-control" ID="dlQuestionType">
                                                    <asp:ListItem Text="Car Owner" Value="1" />
                                                    <asp:ListItem Text="Representative" Value="2" />
                                                    <asp:ListItem Text="Follower ของ Car Owner" Value="3" />
                                                    <asp:ListItem Text="Follower ของ Representative" Value="4" />
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
