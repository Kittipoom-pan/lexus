<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageRepurchase.aspx.cs" Inherits="com.lexus.th.web.master.PageRepurchase" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Repurchase</h3>
        </div>
    </div>

    <div class="row">
        <label class="col-md-2">Repurchase Search</label>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-3">
            <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Repurchase</span></asp:LinkButton>
        </div>
    </div>
            ...
            <asp:UpdatePanel ID="upModalAdd" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <a class="close" data-dismiss="modal">&times;</a>
                            <h4 class="modal-title">Repurchase</h4>
                        </div>
                        <div class="modal-body">
                            <!-- Prefered Model -->
                            <asp:Button ID="btnDetail" runat="server" class="btn btn-default" Text="Repurchase Detail" OnClick="Menu_Click" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="banner" role="tabpanel" aria-labelledby="banner-tab">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Image - Repurchase Banner</label><asp:Label ID="lbImgBanner1" runat="server" ForeColor="Orange"></asp:Label>
                                                ...
                                                <div class="tab-pane" id="bannerDetail" role="tabpanel" aria-labelledby="bannerDetail-tab">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Image - Repurchase Banner Detail</label><asp:Label ID="lbImg1" runat="server" ForeColor="Orange"></asp:Label>
