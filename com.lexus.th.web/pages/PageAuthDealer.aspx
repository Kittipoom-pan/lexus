<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageAuthDealer.aspx.cs" Inherits="com.lexus.th.web.pages.PageAuthDealer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Dealer Authorized Dealer</h3>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Add Authorized Dealer</span></asp:LinkButton>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList runat="server" CssClass="form-control" ID="dlGeo2" DataValueField="GEO_ID" DataTextField="GEO_NAME_EN" OnSelectedIndexChanged="dlGeo2_SelectedIndexChanged" AutoPostBack="true">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="dlProvince" runat="server" CssClass="form-control" AutoPostBack="true" DataValueField="id" DataTextField="name"></asp:DropDownList>
