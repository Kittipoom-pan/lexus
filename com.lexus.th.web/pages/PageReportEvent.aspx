<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageReportEvent.aspx.cs" Inherits="com.lexus.th.web.master.PageReportEvent" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Event Register Report</h3>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvCust" runat="server" AllowPaging="true"
                            ...
                            <Columns>                                
                                ...
                                <asp:BoundField HeaderText="Date/Time" DataField="Date/Time" DataFormatString="{0:dd/MM/yyyy HH:mm:ss}" />
                                ...
                                <asp:BoundField HeaderText="Date of Birth" DataField="Birthdate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Tel." DataField="Tel." />
                                <asp:BoundField HeaderText="E-mail" DataField="E-mail" />
                                <asp:BoundField HeaderText="Register Vin" DataField="Vin" />
                                <asp:BoundField HeaderText="Register Model" DataField="Rigister Model" />
...
<%--                                <asp:BoundField HeaderText="Car No." DataField="Car No." />
                                ...
                                <asp:BoundField HeaderText="Dealer" DataField="Dealer" />
                                <asp:BoundField HeaderText="R/S Date" DataField="R/S Date" DataFormatString="{0:dd/MM/yyyy}" />--%>
                                <asp:BoundField HeaderText="Follower Title" DataField="Follower Title" />
                                <asp:BoundField HeaderText="Follower Name" DataField="Follower Name" />
                                <asp:BoundField HeaderText="Follower Date of Birth" DataField="follower_birthdate" DataFormatString="{0:dd/MM/yyyy}" />
                                <asp:BoundField HeaderText="Follower Tel No." DataField="Follower Tel No." />
                                <asp:BoundField HeaderText="Follower Email" DataField="Follower Email" />
                                <asp:BoundField HeaderText="RelationShip" DataField="RelationShip" />
                                <asp:BoundField HeaderText="RelationShip Other" DataField="relationship_special" />
                                <asp:BoundField HeaderText="Follower Car Brand" DataField="FollowerCarBrand" />
                                <asp:BoundField HeaderText="Car Other" DataField="car_brand_special" />
                                <asp:BoundField HeaderText="Follower Car Year" DataField="follower_year_purchase" />
                            </Columns>
                        </asp:GridView>
                    </ContentTemplate>
                </asp:UpdatePanel>
