<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageECatalogue.aspx.cs" Inherits="com.lexus.th.web.pages.PageECatalogue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">E-Catalogue</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="col-md-8">
                <div class="form-group">
                    ...
                    <asp:TextBox runat="server" CssClass="form-control" ID="tbURLAddress" autocomplete="off" ></asp:TextBox>
                </div>
            </div>
        </div>
        <div class="col-md-12"></div>
