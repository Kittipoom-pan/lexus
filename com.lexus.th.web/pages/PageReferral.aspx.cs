...
{
    public partial class PageReferral : System.Web.UI.Page
    {
            ...
            try
            {
                if (!Page.IsPostBack)
                {
                    ...
                    else
                    {
                        ...
                        ViewState["ImagePath"] = System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePathReferral"];
        ...
        private void BindGridData()
        {
            try
            {
                ReferralService srv = new ReferralService();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                string rdFollowBy = string.Empty;
                ...
                if (rdFollowByCar.Checked) 
                {
                    dlIsrequirePlateNo.SelectedValue = "1";
                    rdFollowBy = "ByCar";
                }
                else if (rdFollowByMember.Checked)
                {
                    dlIsrequirePlateNo.SelectedValue = "0";
                    rdFollowBy = "ByMember";
                }
                ...
                BookingModel referral = new BookingModel()
                {
                    ...
                    FollowingBy = rdFollowBy,
                    MaxUsed = tbByMember.Text
                };
        ...
        protected void btnAddModal_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                tbByMember.Text = "";
                rdFollowByCar.Checked = true;
                tbByMember.Enabled = false;
                rdFollowByMember.Checked = false;
            ...
            try
            {
                ...
                if (gvCust.DataKeys != null)
                {
                    ...
                    if (row != null)
                    {
                        ...
                        string followBy = row["referral_condition"].ToString(); 
                        if (followBy == "ByMember")
                        {
                            rdFollowByMember.Checked = true;
                            tbByMember.Enabled = true;
                        }
                        else if (followBy == "ByCar")
                        {
                            rdFollowByCar.Checked = true;
                            tbByMember.Enabled = false;
                        }
                        tbByMember.Text = row["max_used"].ToString();
