<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageTypeOfService.aspx.cs" Inherits="com.lexus.th.web.master.PageTypeOfService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Type Of Service</h3>
        </div>
    </div>

    <div class="row">
        <label class="col-md-2">Type Of Service Search</label>
        <div class="col-md-5">
    ...
    <div class="row">
        <div class="col-md-3">
            <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Type Of Service</span></asp:LinkButton>
        </div>
    </div>
