...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header" runat="server" id="PageTitle">Privilege Special Quota</h3>
        </div>
    </div>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvCust" runat="server" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="Special Quota" DataField="special_quota" />
                                <asp:BoundField HeaderText="Special Usage" DataField="special_usage" />
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" runat="server" id="dSpecialQuota">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6" runat="server" id="dSpecialUsage">
                                            <div class="form-group">
    ...
    <!-- Modal Add/Edit -->
    <div id="mdUpload" class="modal fade" data-backdrop="static" data-keyboard="false" style="display:none">
        <div class="modal-dialog">
