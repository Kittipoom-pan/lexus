<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PageEventCode.aspx.cs" Inherits="com.lexus.th.web.pages.PageEventCode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:ScriptManager runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Event Code</h3>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <asp:DropDownList ID="dlEvent" runat="server" CssClass="form-control" AutoPostBack="true" DataValueField="EVENT_ID" DataTextField="TITLE" OnSelectedIndexChanged="dlEvent_SelectedIndexChanged"></asp:DropDownList>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <asp:LinkButton ID="btnAddModal" runat="server" CssClass="btn btn-success btn-sm" OnClick="btnAddModal_Click"><span class="glyphicon glyphicon-plus"></span><span> Event Code</span></asp:LinkButton>
                ...
                <asp:UpdatePanel runat="server" ID="upCustGrid">
                    <ContentTemplate>
                        <asp:GridView ID="gvCust" runat="server" AllowPaging="true"
                            CssClass="table table-bordered table-hover" DataKeyNames="EVENT_ID,ID"
        ...
        <asp:UpdatePanel ID="upModalAdd" runat="server" ChildrenAsTriggers="false" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <a class="close" data-dismiss="modal">&times;</a>
                    <h4 class="modal-title">Event Code</h4>
                  </div>
                  <div class="modal-body">
                      <div class="row">
                          <div class="col-md-12">
                              <div class="row">
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <label>Title</label>
                                          <asp:TextBox runat="server" CssClass="form-control" ID="tbEventType" Enabled="false" autocomplete="off" ></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        <label>No</label>
                                          <asp:TextBox runat="server" CssClass="form-control" ID="tbId" Enabled="false" autocomplete="off" ></asp:TextBox>
                                      </div>
                                  </div>
                                  <div class="col-md-6">
                                      <div class="form-group">
                                  ...
                                  <div class="col-md-6">
                                      <div class="form-group">
                                        ...
                                        <asp:DropDownList CssClass="form-control" ID="tbStatus" runat="server" >
                                            <asp:ListItem Text="Not redeem" Value="NotUsed" />
                                            <asp:ListItem Text="Redeem already used" Value="RedeemUsed" />
