<%@ Page Title="" Language="C#" MasterPageFile="~/master/Site1.Master" AutoEventWireup="true" CodeBehind="PagePriceList.aspx.cs" Inherits="com.lexus.th.web.pages.PagePriceList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-md-12">
            <h3 class="page-header">Price List</h3>
        </div>
    </div>
